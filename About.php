 ...
 <section class="ftco-about d-md-flex">
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(<?php echo web_root; ?>plugins/jobportal/images/bg_1.png);" data-stellar-background-ratio="0.5">
    	<div class="container">
